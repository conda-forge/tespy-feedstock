...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tespy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11363&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tespy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tespy` can be installed with:

```
conda install tespy
```

It is possible to list all of the versions of `tespy` available on your platform with:
